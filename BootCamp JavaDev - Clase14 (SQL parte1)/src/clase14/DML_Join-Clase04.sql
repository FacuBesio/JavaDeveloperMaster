...
## CLASES_DETALLE con Consulta
	INSERT INTO clases_detalle(id_clase, id_alumno)
		VALUES 
			(2, (SELECT id_alumno FROM alumnos WHERE num_doc = 154278881 )),
			(2, (SELECT id_alumno FROM alumnos WHERE num_doc = 4627838 )),
			(2, (SELECT id_alumno FROM alumnos WHERE num_doc = 12367881 )),
			(2, (SELECT id_alumno FROM alumnos WHERE num_doc = 46123738 ));
/*JOIN - Tabla temporal con la informacion solicitada */
	...
	INNER JOIN clases_detalle AS c -- right JOIN
