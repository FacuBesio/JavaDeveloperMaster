...
/* Creacion de Tablas */
	## alumnos
		...
		CREATE TABLE alumnos(
            ...
            tipo_doc ENUM('dni', 'dni ext.', 'ci', 'lc', 'le', 'pass'), -- lista de opciones
            num_doc INT UNSIGNED, -- numeros positivos unicamente.
    ...
    ## profesores
		...
		CREATE TABLE profesores(
            ...
            apellido VARCHAR(50),
            nombre VARCHAR(50),
            tipo_doc ENUM('dni', 'dni ext.', 'ci', 'lc', 'le', 'pass'),
			num_doc INT,
		...
		ALTER TABLE profesores
            ...
            -- ADD CONSTRAINT PRIMARY KEY(id_profesor),
            CHANGE correo email VARCHAR(100); #cambiamos el nombre de la Columna correo por email.
