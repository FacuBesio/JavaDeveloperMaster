...
import com.loginBasicoConSpringSecurity.services.IRolService;
import com.loginBasicoConSpringSecurity.services.IUsuarioLoginService;
...
public class LoginController {
    ...
    public String save(Usuario usuario, @RequestParam int idRol) {
    	...
    	return "redirect:/inicioSesion/singup";
    }
    ...
    public String saveRol(Rol rol) {
    	...
    	return "redirect:/inicioSesion/createRole";
    }
